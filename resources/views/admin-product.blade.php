...
<main class="max-w-[1000px] mx-auto ~mt-5/8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-[60%_40%]">
            ...
            <div class="flex flex-col ~gap-3/5 ~p-4/6">
                ...
                <a href="/admin/products/edit" class="w-full flex justify-center bg-black text-white py-4 rounded-full font-semibold hover:bg-zinc-800 transition-colors duration-200">
                    Edit Product
                </a>

                <a href="#" class="w-full border-2 py-4 rounded-full text-red-400 border-red-400 font-semibold transition flex items-center justify-center gap-2 hover:border-red-600 hover:text-red-600 duration-200">
                    Delete Product
                </a>
