...
<main class="max-w-[1000px] mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-[60%_40%]">
        <div class="flex gap-2 sm:gap-4 ~px-2/6 ~pt-4/6 md:sticky md:top-0 md:h-screen md:items-start" data-product-gallery>
            <div class="flex flex-col gap-2 ~w-10/16 shrink-0 md:max-h-[calc(100vh-2rem)] md:overflow-y-auto md:pr-1">
        ...
        <div class="flex flex-col ~gap-3/5 ~px-2/6 ~pt-4/6">
            <div class="mb-4">
