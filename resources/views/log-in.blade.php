...
<div class="flex flex-col items-start justify-start max-w-[500px] mx-auto min-h-screen px-8 py-16 gap-8">
    ...
    <div class="w-full">
      ...
      <form action="/" class="flex flex-col gap-7">
        ...
        <div class="relative">
          <input type="password" id="password" placeholder="Password*" class="w-full px-4 ~py-3/3.5 border-2 border-gray-300 rounded-lg ~text-base/lg focus:border-black outline-none transition-all peer placeholder-transparent">
        ...
        <div class="relative">
          <input type="password" id="confirm-password" placeholder="Confirm Password*" class="w-full px-4 ~py-3/3.5 border-2 border-gray-300 rounded-lg ~text-base/lg focus:border-black outline-none transition-all peer placeholder-transparent">
        ...
        <div>
            ...
            <div class="flex gap-4 w-full">
                ...
                <div class="relative flex-1">
                    <input type="number" id="Month" min="1" max="12" placeholder="Month*"
                        class="w-full px-4 ~py-3/3.5 border-2 border-gray-300 rounded-lg ~text-base/lg text-center focus:border-black outline-none transition-all peer placeholder-transparent">
                    <label for="Month"
                        class="absolute left-4 ~-top-2/2.5 bg-white px-1 text-xs text-gray-500 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-focus:-top-2.5 peer-focus:text-xs">
                        Month*
                ...
                <div class="relative flex-1">
                    <input type="number" id="Year" min="1900" max="2026" placeholder="Year*"
                        class="w-full px-4 ~py-3/3.5 border-2 border-gray-300 rounded-lg ~text-base/lg text-center focus:border-black outline-none transition-all peer placeholder-transparent">
                    <label for="Year"
                        class="absolute left-4 ~-top-2/2.5 bg-white px-1 text-xs text-gray-500 transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-4 peer-focus:-top-2.5 peer-focus:text-xs">
                        Year*
